        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-black tracking-tight text-slate-900 mb-2">
              Learning<span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-blue-500 underline decoration-indigo-200 decoration-4 underline-offset-8 ml-2">Inventory</span>
            </h1>
